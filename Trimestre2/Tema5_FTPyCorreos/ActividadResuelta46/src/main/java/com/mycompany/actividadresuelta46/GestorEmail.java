...
public class GestorEmail {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            String passwordEmisor = "likt hjet gkav gteb";  // Codigo de "Contraseñas de aplicacion"


            GestorEmail gestorEmail = new GestorEmail();
            gestorEmail.enviarMensajeTexto(emailEmisor, "alvaro.ruiz.enriquez@hotmail.com",
                    "Aviso de entrega de factura", "El importe de la factura"
                    + " es 113,72€", emailEmisor, passwordEmisor);

            gestorEmail.enviarMensajeConAdjunto(emailEmisor, "alvaro.ruiz.enriquez@hotmail.com",
                    "Aviso de entrega de factura", "El importe de la factura"
