...
public class GestorApi {
    ...
    try {
        ...
        formattedJSON.append("-------------Fake Store-------------\n");
        formattedJSON.append("ID: ").append(jsonObject.getInt("id")).append("\n");
        formattedJSON.append("Titulo: ").append(jsonObject.getString("title")).append("\n");
        formattedJSON.append("Descripcion: ").append(jsonObject.getString("description")).append("\n");
        formattedJSON.append("Categoria: ").append(jsonObject.getString("category")).append("\n");
        formattedJSON.append("Precio: ").append(jsonObject.getDouble("price")).append("\n");
